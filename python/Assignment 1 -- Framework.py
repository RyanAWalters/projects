...
def makePyramid():
    ...
    pyramidMesh.pointList.append([0,50,100])
    pyramidMesh.pointList.append([-50,-50,50])
    pyramidMesh.pointList.append([50,-50,50])
    pyramidMesh.pointList.append([50,-50,150])
    pyramidMesh.pointList.append([-50,-50,150])
    ...
    pyramidMesh.polyList.append(pyramidMesh.pointList[4],pyramidMesh.pointList[3],pyramidMesh.pointList[2],pyramidMesh.pointList[1])

    pyramidMesh.meshDef = [polyList[0],polyList[1],polyList[2],polyList[3],polyList[4]]
    
    pyramidMesh.pointCloud
